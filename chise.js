...
/*     var oldSource = param.edge.source().id();
        ...
        var segmentPoints = param.edge.segmentPoints();

        param.edge.data().source = oldTarget;
        param.edge.data().target = oldSource;
        param.edge.data().portsource = oldPortTarget;
        param.edge.data().porttarget = oldPortSource;
          param.edge = param.edge.move({
            target: oldSource,
            source : oldTarget        
        });

        param.edge.data().bendPointPositions = segmentPoints;
        var edgeEditing = cy.edgeEditing('get');
        edgeEditing.initBendPoints(param.edge); */
