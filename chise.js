...
module.exports = function () {
  ...
  var registerUndoRedoActions = function (param) {
    ...
    ur.action("createDegredation", undoRedoActionFunctions.createDegredation, undoRedoActionFunctions.deleteElesSimple);
